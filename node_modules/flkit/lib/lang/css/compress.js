...
var CssCompress = function (_Base) {
  ...
  CssCompress.prototype.collectSelector = function collectSelector(token) {
    var selectorPos = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
  ...
  CssCompress.prototype.compressSelector = function compressSelector() {
    ...
    if (this.options.sortSelector) {
      var i = 0;
      var sortedSelectors = [];
      var chunk = this.options.sortSelectorChunk;
      while (true) {
        var chunkSelectors = selectors.slice(i * chunk, (i + 1) * chunk);
  ...
  CssCompress.prototype.run = function run() {
    ...
    while (this.index < this.length) {
      ...
      switch (token.type) {
        ...
        default:
          if ((0, _util.isAtType)(token.type) || token.type === _token_type2.default.CSS_SUPPORTS) {
            this.compressSelector();
          }
          ...
          if (token.type === _token_type2.default.CSS_CHARSET) {
            ...
            hasCharset = true;
          } else if (token.type === _token_type2.default.TPL) {
            // console.log(token)
            this.compressSelector();
            this.result.push(token);
          } else {
