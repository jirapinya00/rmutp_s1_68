...
function short4NumValue(value) {
  ...
  var returnArray = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
...
function mergePropertyChildren(attrs) {
  ...
  var type = arguments.length <= 1 || arguments[1] === undefined ? 'padding' : arguments[1];
  ...
  for (var key in attrs) {
    ...
    var property = _attrs$key.property;
    var value = _attrs$key.value;
  ...
  if (properties[type]) {
    ...
    var _ret2 = function () {
      ...
      var shortValue = short4NumValue(value);
